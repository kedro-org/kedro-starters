...
from {{ cookiecutter.package_name }}.pipelines import data_ingestion as di
from {{ cookiecutter.package_name }}.pipelines import feature_engineering as fe
from {{ cookiecutter.package_name }}.pipelines import modelling as mod
from {{ cookiecutter.package_name }}.pipelines import reporting as rep
